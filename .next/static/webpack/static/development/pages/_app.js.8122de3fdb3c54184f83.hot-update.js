...
var initAnalytics = function initAnalytics() {
  react_ga__WEBPACK_IMPORTED_MODULE_0__["default"].initialize('UA-157971736-1');
};
var reportEvent = function reportEvent(params) {
  // if (env !== 'prod') return;
  react_ga__WEBPACK_IMPORTED_MODULE_0__["default"].event(params);
};
var reportScreen = function reportScreen(screenName) {
  // if (env !== 'prod') return;
  react_ga__WEBPACK_IMPORTED_MODULE_0__["default"].pageview(screenName);
};

/***/ })

})
//# sourceMappingURL=_app.js.8122de3fdb3c54184f83.hot-update.js.map