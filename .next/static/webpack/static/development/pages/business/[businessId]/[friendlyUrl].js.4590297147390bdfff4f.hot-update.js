...
/***/ "./pages/business/[businessId]/[friendlyUrl].js":
/*!******************************************************!*\
  !*** ./pages/business/[businessId]/[friendlyUrl].js ***!
  \******************************************************/
...
/* harmony import */ var _src_containers_BusinessPage__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../src/containers/BusinessPage */ "./src/containers/BusinessPage/index.js");
/* harmony import */ var _src_reducers_BusinessPage_actions__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../src/reducers/BusinessPage/actions */ "./src/reducers/BusinessPage/actions.js");
...
/* harmony import */ var _src_constants__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../../src/constants */ "./src/constants.js");
...
var _jsxFileName = "/Users/kobimantzur/mapo/hello-next/pages/business/[businessId]/[friendlyUrl].js";
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_13__["default"])(Business, _Component);

  function Business() {
    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_9__["default"])(this, Business);

    return Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_11__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_12__["default"])(Business).apply(this, arguments));
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_10__["default"])(Business, [{
    key: "getPageTitle",
    value: function getPageTitle() {
      ...
      if (!business.title) {
        ...
        return _src_constants__WEBPACK_IMPORTED_MODULE_20__["DEFAULT_PAGE_TITLE"];
      }

      return "Mapo | \u05D4\u05DE\u05DC\u05E6\u05D4 \u05E2\u05DC ".concat(business.subCategories[0].title, " \u05D1").concat(business.placements[0].heName);
    }
  }, {
    key: "getMetaImage",
    ...
    value: function getMetaDescription() {
      ...
      try {
        return "".concat(business.description.slice(0, 130));
      } catch (e) {
        return '';
      }
    }
    ...
    value: function render() {
      return __jsx("div", {
        ...
        __self: this
      })), __jsx(_src_containers_BusinessPage__WEBPACK_IMPORTED_MODULE_17__["default"], Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_8__["default"])({}, this.props, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 60
        },
    ...
    value: function getInitialProps(_ref) {
      var store, isServer, pathname, query, ctx, businessId, res;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 2;
              _context.next = 5;
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_6___default.a.awrap(store.dispatch(Object(_src_reducers_BusinessPage_actions__WEBPACK_IMPORTED_MODULE_18__["getBusinessByFriendlyUrl"])(businessId)));

            case 5:
              res = _context.sent;
              return _context.abrupt("return", _objectSpread({}, res));
...
//# sourceMappingURL=[friendlyUrl].js.4590297147390bdfff4f.hot-update.js.map